...
export function Plan() {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-black transition-colors duration-300">
      <header className="flex items-center px-4 h-16 border-b border-gray-100 dark:border-slate-800 shrink-0 sticky top-0 bg-white/45 dark:bg-black/45 backdrop-blur-xl z-10 transition-colors duration-300 shadow-sm">
